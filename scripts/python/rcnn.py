...
sys.path.insert(0,params['caffe_path'] + 'python')
import caffe
...
class Detector(caffe.Net):
    ...
    def detect_windows(self, images_windows):
        ...
        print "The shape of the extracted features - fc7", np.shape(np.squeeze(out['fc7']))
        print "The shape of the extracted features - fc8", np.shape(np.squeeze(out['fc-rcnn']))

        predictions = np.squeeze(out['fc7'])
